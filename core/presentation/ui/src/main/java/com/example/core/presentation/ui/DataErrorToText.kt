...
fun DataError.asUiText(): UiText {
    return when(this) {
        ...
        DataError.Network.TOO_MANY_REQUESTS -> UiText.StringResource(R.string.error_too_many_requests) // This doesn't have to be shown to the user, but for debugging purposes we'll show it
